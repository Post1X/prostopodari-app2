    ...
    const messageFunc = async () => {
        try {
            ...
            navigation.navigate(MessagesName, {
                item: {
                    user_id: item?.store_id?.seller_user_id,
        ...
        // navigation.navigate(MessagesName,{item:{user_id:item.store_id.seller_user_id}})
    }
    return (
                    ...
                    <View style={[globalStyles.row]}>
                        ...
                        <View style={styles.textCont}>
                            <Text
                                ...
                                на открытке:</Text>
                            <Text
                                style={[globalStyles.titleText, globalStyles.weightBold, globalStyles.titleTextSmall, globalStyles.textAlignLeft, styles.priceText]}>{item?.postcard} р</Text>
                        </View>
                    </View>
                </View>
            </View>
