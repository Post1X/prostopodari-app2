                    ...
                    <View style={styles.onas}>
                        <View>
                            ...
                            <View style={styles.placeContainer}>
                                ...
                                <Text
                                    style={[globalStyles.titleText, globalStyles.weightLight, globalStyles.titleTextSmall4]}>{shop?.city}</Text>
                            </View>
                            <View style={styles.placeContainer}>
                        ...
                        <View style={styles.contView}>
                            <Text
                                ...
                                работы</Text>
                            <Text
                                style={[globalStyles.titleText, globalStyles.weightBold, globalStyles.titleTextSmall4, globalStyles.textAlignLeft]}>ПН-ПТ: <Text
                                style={globalStyles.weightLight}>09:00—21:00</Text></Text>
                            <Text
                                style={[globalStyles.titleText, globalStyles.weightBold, globalStyles.titleTextSmall4, globalStyles.textAlignLeft]}>СБ-ВС: <Text
                                style={globalStyles.weightLight}>выходной </Text></Text>
                        </View>
                        <View style={styles.contView}>
                            <Text
                                ...
                                нас</Text>
                            <Text
                                style={[globalStyles.titleText, globalStyles.weightLight, globalStyles.titleTextSmall4, globalStyles.textAlignLeft]}>09:00—21:00</Text>
