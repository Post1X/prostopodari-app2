    ...
    return (
        <ScrollView contentContainerStyle={globalStyles.scrollContainer}>
            <View style={styles.cont}>
                <View>
                    ...
                    <View style={styles.content}>
                        ...
                        <View style={[globalStyles.row, styles.rowCont]}>
                            <Text
                                style={[globalStyles.titleText, globalStyles.textAlignLeft, styles.textCont]}>{data.price} р</Text>
                        ...
                        <View style={styles.timeContainer}>
                            ...
                            <Text
                                style={[globalStyles.titleText, globalStyles.textAlignLeft, globalStyles.weightLight, globalStyles.titleTextSmall]}>Стоимость доставки: <Text style={styles.grayText}>{data.store_id.comission} р</Text></Text>
                        </View>
                ...
                <View>
                    <TouchableOpacity onPress={()=>navigation.navigate(ShopName,{shop:data.store_id})} style={styles.shopContAll}>
                    ...
                    <View style={styles.footerCont}>
                        ...
                        <TouchableOpacity style={styles.btnView} onPress={() => {
                            ...
                            <View style={styles.priceFooter}>
                                ...
                                <Text
                                    style={[globalStyles.titleText, globalStyles.textAlignLeft, globalStyles.titleTextSmall4, globalStyles.weightLight, styles.priceText]}>{data?.price * count} p</Text>
                            </View>
